...
var KTDatatableLocalSortDemo = function() {
    ...
    var messages = {
        'ar': {
            'Reason': "السبب",
            'First Panel': "جزاء اول مرة",
            'Second Panel': "جزاء ثاني مرة",
            'Third Panel': "جزاء ثالث مرة",
                        ...
                        swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    url: '/dashboard/violations/' + data.id,
                                    error: function (err) {
            ...
            columns: [
                {
                    ...
                    field: 'panel1',
                    title: locator.__('First Panel'),
                    textAlign: 'center',
                }, {
                    field: 'panel2',
                    title: locator.__('Second Panel'),
                    textAlign: 'center',
                }, {
                    field: 'panel3',
                    title: locator.__('Third Panel'),
                    textAlign: 'center',
                }, {
                    field: 'panel4',
                    title: locator.__('Fourth Panel'),
                    textAlign: 'center',
                }, {
                    field: 'addition_to',
                    title: locator.__('Addition To'),
                    textAlign: 'center',
                        ...
                        return '\
		                  <div class="dropdown">\
		                      ...
		                      <div class="dropdown-menu dropdown-menu-right">\
		                          <a class="dropdown-item" href="/dashboard/violations/' + row.id + '/edit" ><i class="la la-pencil-square-o"></i>' + locator.__('Edit Info') + '</a>\
