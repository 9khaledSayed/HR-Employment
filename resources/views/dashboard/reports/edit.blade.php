...
@section('content')
    ...
    <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{route('dashboard.reports.update', $report)}}">
            @csrf
            @method('put')
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <select class="form-control @error('employee_id') is-invalid @enderror kt-selectpicker"
                            ...
                            @forelse($employees as $employee)
                                <option
                                    value="{{$employee->id}}"
                                    @if((old('employee_id') ?? $report->employee->id) == $employee->id) selected @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <div class="input-group date">
                            <input name="violation_date" value="{{old('violation_date') ?? $report->violation_date}}" type="text" class="form-control datepicker" readonly/>
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="{{route('dashboard.reports.index')}}" class="btn btn-secondary">{{__('back')}}</a>
                        </div>
                    </div>
                </div>
            </div>
